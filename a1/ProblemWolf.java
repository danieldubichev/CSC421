...
class ProblemWolf extends Problem{
    ...
    //index 0: boat; 1: wolf  2:goat;   3:cabbage
    ...
    Set<Object> getSuccessors(Object state){
         ...
         ss = new StateWolf(s1);
         if((s1.possible[0] == 0) && (s1.possible[1] == 0) && (s1.possible[2] == 0) && (s1.possible[3] == 1)){
             set.add(ss);
         }
         ss = new StateWolf(s1);
         if((s1.possible[0] == 1) && (s1.possible[1] == 1) && (s1.possible[2] == 0) && (s1.possible[3] == 1)){
             set.add(ss);
         }
         ss = new StateWolf(s1);
